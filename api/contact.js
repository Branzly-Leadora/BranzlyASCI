...
//   CONTACT_TO     — cílová schránka (výchozí ahoj@branzly.cz)
//   CONTACT_FROM   — ověřený odesílatel (výchozí onboarding@resend.dev,
//                    po ověření vlastní domény např. web@branzly.cz)
...
export default async function handler(req, res) {
  ...
  const to = process.env.CONTACT_TO || "ahoj@branzly.cz";
  const from = process.env.CONTACT_FROM || "Branzly Web <onboarding@resend.dev>";
